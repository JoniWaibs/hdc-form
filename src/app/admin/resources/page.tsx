  ...
  return (
    <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <ResourcesFilters />
        <Button asChild>
          <Link href="/admin/resources/new" className="cursor-not-allowed pointer-events-none opacity-50">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Administra tus recursos y accede a sus dashboards específicos.</CardDescription>
        </CardHeader>
        <CardContent>
